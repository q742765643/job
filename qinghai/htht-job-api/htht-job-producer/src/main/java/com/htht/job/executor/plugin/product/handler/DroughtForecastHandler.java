...
@JobHandler(value = "droughtForecastHandler")
@Service
public class DroughtForecastHandler extends IJobHandler{
	...
	public ReturnT<String> execute(TriggerParam triggerParam) throws Exception {
		...
		result = droughtForecastService.execute(triggerParam, result);
