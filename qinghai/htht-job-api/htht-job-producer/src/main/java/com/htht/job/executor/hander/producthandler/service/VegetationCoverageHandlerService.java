...
@Transactional
@Service("vegetationCoverageHandlerService")
public class VegetationCoverageHandlerService  extends BasePlugin{
	...
	public Map<String, Object> getInputParam(TriggerParam triggerParam, String issue) throws IOException {
		...
		if(null!=files && !files.isEmpty()){
			for(File f:files){
				// MOD13Q1_EOST_201909140000_0250M_V06_XXXX_AEA_112131.tif
				String date = f.getName().split("_")[2];
