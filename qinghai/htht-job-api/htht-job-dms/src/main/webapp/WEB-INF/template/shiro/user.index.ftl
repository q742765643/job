            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="password" class="form-control" id="ackPassword" name="ackPassword" maxlength="20">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="modelName" class="col-sm-2 control-label">用户名称</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="userName" maxlength="50" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <label for="ackPassword2" class="col-sm-2 control-label">确认密码</label>
                        <div class="col-sm-4">
