...
<div class="wrapper" style="overflow: hidden">
    ...
    <aside class="main-sidebar">
        ...
        <li class=" treeview">
           ...
           <#-- <i class="fa fa-repeat"></i> <span>任务管理</span> -->
                <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
            </a>
        ...
        <li class=" treeview">
            <a href="#">
                <i class="fa fa-repeat"></i> <span>数管调度</span>
                <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
            </a>
       ...
       <li class=" treeview">
            <a href="#">
                <i class="fa fa-repeat"></i> <span>产品生产</span>
                <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
            </a>
        ...
        <@shiro.hasPermission name="RSproduct">
                <li><a href="${request.contextPath}/product/RSproduct" target="view_frame" onclick="loadIframe($(this))">
                    <i class="fa fa-circle-o"></i>
                    遥感业务任务调度</a></li>
        </@shiro.hasPermission>
        <@shiro.hasPermission name="AMPproduct">
                <li><a href="${request.contextPath}/product/AMPproduct" target="view_frame" onclick="loadIframe($(this))">
        ...
        <@shiro.hasPermission name="productmanage">
          ...
          <i class="fa fa-angle-left pull-right"></i>
             ...
             <@shiro.hasPermission name="ywsjgl">      
                    <li class="treeview">
                        <a href="${request.contextPath}/ywsjgl" target="view_frame" onclick="loadIframe($(this))">
                            <i class="fa fa-pie-chart"></i>
                            <span>农气要素查询</span>
                   <span class="pull-right-container">
                    </span>
...
<@shiro.hasPermission name="dbms_system">
        ...
        <@shiro.hasPermission name="uus_system">
         ...
         <@shiro.hasPermission name="dicCode">
			...
			<li class=" treeview">
                <a href="http://10.181.23.77:8082/ku/" target="_blank" >
                    <i class="fa fa-database"></i> <span>算法库</span>
                    <span class="pull-right-container">
              	<i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
			...
			<li class=" treeview">
                <a href="http://10.181.23.77:8082/qxzh/" target="_blank" >
                    <i class="fa fa-database"></i> <span>气象灾害风险区划系统</span>
                    <span class="pull-right-container">
              	<i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
