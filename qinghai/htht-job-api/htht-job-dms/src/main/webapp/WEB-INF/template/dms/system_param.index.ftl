...
<section class="content">
    <div class="row">
        <div class="col-sm-12">
            <div class="row">
                <div class="col-xs-2">
                    <input type="text" class="form-control" id="searchText" autocomplete="on" placeholder="按参数名称搜索...">
                </div>
                <div class="col-xs-1">
                ...
                <@shiro.hasPermission name="useradd">
                    <button class="btn btn-primary btn-success add" >添加参数</button>
                </@shiro.hasPermission>
                </div>
            </div>
            <p></p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">添加系统参数</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="paramname" maxlength="50">
                        </div>
                        <label for="lastname" class="col-sm-2 control-label">参数编码</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="password" name="paramvalue">
                        </div>
                        <#--<label for="ackPassword" class="col-sm-2 control-label">确认密码</label>
                        <div class="col-sm-4">
                            <input type="password" class="form-control" id="ackPassword" name="ackPassword">
                        </div> -->
                    </div>
                    <#--<div class="form-group">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">修改系统参数</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="modelName" class="col-sm-2 control-label">参数名称</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="paramname" maxlength="50">
                            <input type="hidden" class="form-control" name="id" maxlength="50">
                    ...
                    <div class="form-group">
                        <label for="password" class="col-sm-2 control-label">参数值</label>
                        <div class="col-sm-4">
...
<script src="${request.contextPath}/static/js/dms/system_param.index.1.js"></script>
