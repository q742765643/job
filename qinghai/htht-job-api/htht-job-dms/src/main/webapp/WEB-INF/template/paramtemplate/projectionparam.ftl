...
<div class="form-group">
    ...
    <div class="col-sm-4">
        ...
        <select class="form-control" id="preDataTaskName" name="preDataTaskName">
            <option value="FY3D_MWRI_1000">FY3D_MWRI</option>
            <option value="FY4A_AGRI_4000">FY4A_AGRI_ALL</option>
            <option value="NPP_VIIRS_1000">NPP_VIIRS</option>
            <option value="NOAA18_AVHRR_1000">NOAA18_AVHRR</option>
            <option value="NOAA19_AVHRR_1000">NOAA19_AVHRR</option>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select class="form-control" id="projectionIdentify" name="projectionIdentify">
            ...
            <option value="AEA">阿尔波斯投影</option>
            <option value="AEA_QH">青海阿尔波斯投影</option>
        </select>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div id="projectionDaysDiv" >
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="downloadDays" value="${downParam.downloadDays}"  placeholder="1" maxlength="100" >
        </div>
    </div>
...
<div class="form-group">
    <label for="modelName" class="col-sm-2 control-label">输入文件路径:</label>
    <div class="col-sm-4">
        <input type="text" class="form-control" name="inputDataFilePath"  value="${projectionParam.inputDataFilePath}" placeholder="输入文件路径" maxlength="500" >
    </div>
    <label for="modelName" class="col-sm-2 control-label">时间正则:</label>
    <div class="col-sm-4">
        <input type="text" class="form-control" name="fileNamePattern"  value="${projectionParam.fileNamePattern}" placeholder="输入时间正则" maxlength="500" >
    </div>
</div>
<script>
    ...
    var selectProjectionIdentify = document.getElementById("projectionIdentify");
    for (var i = 0; i < selectProjectionIdentify.options.length; i++) {
        if (selectProjectionIdentify.options[i].value == "${projectionParam.projectionIdentify}") {
            selectProjectionIdentify.options[i].selected = true;
            break;
        }
    }
