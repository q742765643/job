        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <@shiro.hasPermission name="useradd">
                    <button class="btn btn-primary btn-success add" >添加用户</button>
                </@shiro.hasPermission>
                </div>
            </div>
            <p></p>
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="userName" maxlength="50" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <label for="ackPassword" class="col-sm-2 control-label">确认密码</label>
                        <div class="col-sm-4">
                            <input type="password" class="form-control" id="updateAckPassword" name="updateAckPassword">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="modelName" class="col-sm-2 control-label">状态</label>
...
<script src="${request.contextPath}/static/js/dataAdmin/user.index.1.js"></script>
