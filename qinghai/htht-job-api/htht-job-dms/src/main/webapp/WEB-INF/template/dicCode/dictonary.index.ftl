...
<section class="content">
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-xs-2">
                    <input type="text" class="form-control" id="searchText" autocomplete="on" placeholder="按字典名称搜索...">
                </div>
                <div class="col-xs-2">
                ...
                <div class="col-xs-1">
                    <@shiro.hasPermission name="resourceadd">
                        <button class="btn btn-primary btn-success add">添加字典</button>
                    </@shiro.hasPermission>
                </div>
            </div>
            <p></p>
            <div class="box">
                <div class="box-body">
                    <table id="dicCodeTable" class="table table-bordered table-striped"
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">字典编码</label>
                        <div class="col-sm-4">
                            <input name="dictCode" class="form-control" type="text" placeholder="请输入字典编码"/>
                            <input name="parentId" class="form-control" type="hidden"/>

                        </div>
                        <label for="modelName" class="col-sm-2 control-label">字典名称</label>
                        <div class="col-sm-4">
                            <input name="dictName" class="form-control" type="text" placeholder="请输入字典名称"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" rows="3" name="memo" placeholder="请输入字典用途"></textarea>
                        </div>
                        <label class="col-sm-2 control-label">排序</label>
                        <div class="col-sm-4">
                            <input id="sort" name="sortOrder" class="form-control" placeholder="请输入字典排序">
                        </div>
                    </div>
                    <div class="form-group">
                    </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">字典编码</label>
                        <div class="col-sm-4">
                            <input name="dictCode" class="form-control" type="text"/>
                            <input name="id" class="form-control" type="hidden"/>

                        </div>
                        <label for="modelName" class="col-sm-2 control-label">字典名称</label>
                        <div class="col-sm-4">
                            <input name="dictName" class="form-control" type="text"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input id="level" name="sortOrder" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-5 col-sm-6">
...
<script src="${request.contextPath}/static/js/dicCode/dicCode.index.1.js"></script>
