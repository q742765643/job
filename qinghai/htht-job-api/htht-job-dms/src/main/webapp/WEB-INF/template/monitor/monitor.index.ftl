                ...
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="registryKey"
                                                      placeholder="请输入节点名称" maxlength="50"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="registryIp"
                                                      placeholder="请输入节点ip" maxlength="50"></div>
                    </div>
                    <hr>
                    <div class="form-group">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id = "deployId" ></h4>
            </div>
            
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
	                <div class=" col-sm-2">
	                    <label for="lastname" class="col-sm-2 control-label">PIEOrtho算法<font color="red">*</font></label>
	                </div>
	                <div id="treeview1"></div>
                    <div class="form-group" >
                        <label for="lastname" class="col-sm-2 control-label">节点IP<font color="red">*</font></label>
                        <div class="col-sm-8"><input type="text" class="form-control" name="registryIp"
                                                      placeholder="请输入节点ip" maxlength="50"></div>
                    </div>
                    <hr>
                    <div class="form-group">
