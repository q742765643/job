...
$(function() {
    table = $("#table").dataTable({
        ...
        "aaSorting": [[1, "asc"]],
        "ajax": {
            url: base_url + "uus_role/pageList",
            type: "post",
            data: function(d) {
                var obj = {};
                var obj = {
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "uus_role/saveRole", $("#addModal .form").serialize(),
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "uus_role/saveRole", $("#updateModal .form").serialize(),
                function(data, status) {
                    if (data.code == "200") {
    ...
    var grantModalValidate = $("#grantModal .form").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: base_url + "uus_role/grant/" + id,
    ...
    layer.confirm('确认删除?', {
        ...
        function(index) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: base_url + "uus_role/delRole/" + id,
                success: function(data) {
                    if (data.code == 200) {
                    	layer.msg( "删除成功", {
        					icon: 1,
