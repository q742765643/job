...
CREATE TABLE HTHT_MASTER_SCHEDULE_TRIGGERS
  (
    ...
    FOREIGN KEY (SCHED_NAME,JOB_NAME,JOB_GROUP)
        REFERENCES HTHT_MASTER_SCHEDULE_JOB_DETAILS(SCHED_NAME,JOB_NAME,JOB_GROUP)
);
...
CREATE TABLE HTHT_MASTER_SCHEDULE_SIMPLE_TRIGGERS
  (
    ...
    FOREIGN KEY (SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP)
        REFERENCES HTHT_MASTER_SCHEDULE_TRIGGERS(SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP)
);
...
INSERT INTO `HTHT_MASTER_SCHEDULE_TRIGGER_GROUP` ( `app_name`, `title`, `order`, `address_type`, `address_list`) values ( 'xxl-job-executor-sample', '示例执行器', '1', '0', null);
