...
public class JobFlowController {
    ...
    public String add(Model model,String tasktype) {
        ...
        List<FlowChartModel> flowChartModelList = dubboService.findFlowList();
        model.addAttribute("flowModelList", flowChartModelList);
    ...
    public String getUpdateParameters(String id,String modelId) {
        TaskParameters taskParameters = taskParametersService.findJobParameterById(id);
        List<CommonParameter> commonParameters = JSON.parseArray(taskParameters.getDynamicParameter(), CommonParameter.class);
