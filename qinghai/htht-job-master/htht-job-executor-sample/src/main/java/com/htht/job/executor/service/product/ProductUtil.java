...
public class ProductUtil {
	 ...
	 * @return
	 */
	public ProductInfo saveProductInfo(String productId, String regionId,
	 ...
	 * @return
	 */
	public ProductInfo saveProductInfoNdvi(String productId, String regionId,
			String issue, String cycle, String mosaicFile,
			String modelIdentify, String inputFileName) {
		Product p = productService.findById(productId);
		ProductInfo pi = new ProductInfo();
	 ...
	 * @param outputPath
	 */
	public ProductFileInfo saveProductInfoFile(String productInfoId, String filePath,
		...
		ProductFileInfo pfi = new ProductFileInfo();
		...
		pfi.setIssue(issue);
		pfi.setCycle(cycle);
		return productFileInfoService.save(pfi);
	}
}
