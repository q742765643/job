 ...
 */
@Entity
@Table(name = "t_r_agme_c06_ele")
@ExcelSheet(name = "关键农事活动表", headColor = HSSFColorPredefined.LIGHT_GREEN)
public class Crop06 implements Serializable {
	...
	@ExcelField(name = "方法和工具")
	private String methodsAndTools; // 方法和工具
	...
	public String getMethodsAndTools() {
		return methodsAndTools;
	}

	public void setMethodsAndTools(String methodsAndTools) {
