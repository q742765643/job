 ...
 */
@Entity
@Table(name = "t_r_agme_c04_ele")
@ExcelSheet(name = "产量因素表", headColor = HSSFColorPredefined.LIGHT_GREEN)
public class Crop04 implements Serializable {
    ...
    @ExcelField(name = "发育")
	private int maturity; // 发育
    @ExcelField(name = "项目名称")
	private int projectName; // 项目名称
    @ExcelField(name = "测定值")
