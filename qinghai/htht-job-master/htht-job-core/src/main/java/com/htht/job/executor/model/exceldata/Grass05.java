...
/**
 * 
 * Description: 灌木、半灌木密度
 * 
 * @author chensi
 * @date 2019年1月7日
 */
@Entity
@Table(name = "t_r_agme_g05_ele")
public class Grass05 implements Serializable{
    ...
    @ExcelField(name = "每公顷株丛数")
	private String numberPlantsPerHectare; // 每公顷株丛数
    @ExcelField(name = "每公顷总株丛数")
	private String totalPlantsPerHectare;  // 每公顷总株丛数
	public int getId() {
		return id;
	}
	...
	public String getNumberPlantsPerHectare() {
		return numberPlantsPerHectare;
	}
	public void setNumberPlantsPerHectare(String numberPlantsPerHectare) {
		this.numberPlantsPerHectare = numberPlantsPerHectare;
	}
	public String getTotalPlantsPerHectare() {
		return totalPlantsPerHectare;
	}
	public void setTotalPlantsPerHectare(String totalPlantsPerHectare) {
		this.totalPlantsPerHectare = totalPlantsPerHectare;
	}
