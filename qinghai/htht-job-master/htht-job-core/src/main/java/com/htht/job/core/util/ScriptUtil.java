...
public class ScriptUtil {
    ...
    public static int execToFile(String command, String scriptFile, String logFile, String... params) throws IOException {
        ...
        ExecuteWatchdog watchdog = new ExecuteWatchdog(60*60*60*1000);
    ...
    public static int execCmd(String command,String outputLog) throws IOException {
        FileOutputStream fileOutputStream = null;
        try {
            fileOutputStream = new FileOutputStream(outputLog, true);
        PumpStreamHandler streamHandler = new PumpStreamHandler(fileOutputStream, fileOutputStream, null);
    ...
    public static void main(String[] args) throws IOException {
      ...
      int a=  ScriptUtil.execCmd("java -jar /zzj/data/logs/Demo.jar 111 1111","/zzj/data/logs/111.log");
