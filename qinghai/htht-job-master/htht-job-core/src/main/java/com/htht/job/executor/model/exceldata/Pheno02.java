 ...
 */
@Entity
@Table(name = "t_r_agme_p02_ele")
public class Pheno02 implements Serializable {
	...
	@Column(name="hydrological_phenomena_name")
	@ExcelField(name = "水文现象名称")
	private String hydrologicalPhenomenaName; // 水文现象名称
	...
	public String getHydrologicalPhenomenaName() {
		return hydrologicalPhenomenaName;
	}

	public void setHydrologicalPhenomenaName(String hydrologicalPhenomenaName) {
		this.hydrologicalPhenomenaName = hydrologicalPhenomenaName;
	}
