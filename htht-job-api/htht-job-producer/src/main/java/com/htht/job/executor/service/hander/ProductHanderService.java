...
@Transactional
@Service("productHanderService")
public class ProductHanderService {
    @Autowired
...
//TODO                productFileInfo.setProductId(product.getId());
                productFileInfoDTO =productFileInfoService.save(productFileInfoDTO);
                ...
                for(Map map:mapList){
                    ...
                    fileInfoDTO.setFilepath(path);
                    fileInfoDTO.setProductFileInfoId(productFileInfoDTO.getId());
                    fileInfoDTO.setFiletype((String)map.get("type"));
                    fileInfoService.save(fileInfoDTO);
                }
