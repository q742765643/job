...
@Service("dataArchiveHandlerServiceQX")
public class DataArchiveHandlerServiceQX {
	@Autowired
...
//						FileUtils.copyDirectoryToDirectory(baseFile, new File(archiveDisk.getLoginurl()+"/"+handlerParam.getArchivePath()));
						/*20180831-弃用文件夹形式end*/
