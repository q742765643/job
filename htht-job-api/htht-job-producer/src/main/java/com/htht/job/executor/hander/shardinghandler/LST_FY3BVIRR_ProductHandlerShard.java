 ...
 *
 */
@Service("lST_FY3BVIRR_ProductHandlerShard")
public class LST_FY3BVIRR_ProductHandlerShard extends StandardShard{
...
//			paramMap.put("startHour", startHourInString);
//			paramMap.put("endHour", endHourInString);
//		}
