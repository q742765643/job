...
<div class="form-group">
    ...
    <div id="downloadSourcePath">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="forPath"  value="${downParam.forPath}" placeholder="下载源目录" maxlength="50" >
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" name="toPath"  value="${downParam.toPath}"  placeholder="请输入目标目录路径" maxlength="100" >
    </div>
    <div id="toFtpDiv">
    <label for="modelName" class="col-sm-2 control-label">选择FTP:</label>
    <div class="col-sm-4">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" name="downFileNamePattern"  value="${downParam.downFileNamePattern}"  maxlength="100" >
    </div>
...
<div class="form-group">
    <div id="downloadDaysDiv" >
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="downloadDays" value="${downParam.downloadDays}"  placeholder="请输入下载天数" maxlength="100" >
        </div>
    </div>
...
<script>
    $("input[name='forSouceType']").click(function(){
        ...
        if(val!='modis'){
            ...
            $("input[name='dataTimePattern']").attr("disabled", false);
        }else{
            $('#downloadSourcePath').hide();
            $('#forFtpDiv').hide();
            $('#modisSourceType').show();
            $("input[name='dataTimePattern']").val("");
            $("input[name='dataTimePattern']").attr("disabled", "disabled");
        }
    });
