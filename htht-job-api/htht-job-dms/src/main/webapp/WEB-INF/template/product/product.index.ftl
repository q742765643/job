                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="name" maxlength="100" readonly>
                                <input type="hidden" class="form-control" name="menu" maxlength="100">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="mark" maxlength="100" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="modelName" class="col-sm-2 control-label">产品路径</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="productPath" maxlength="100" readonly>

                            </div>
                            <label for="lastname" class="col-sm-2 control-label">产品周期</label>
                            <div class="col-sm-4"><input type="text" class="form-control" name="cycle" maxlength="100"
                                                         readonly></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="gdbPath" maxlength="100"
                                                         readonly>
                            </div>
                        ...
                        <#--<label for="lastname" class="col-sm-2 control-label">产品审核</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="isRelease" maxlength="100" value="人工审核" disabled>
                        </div>-->
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="menu" maxlength="100" disabled>
                            <input type="hidden" class="form-control" name="parentId">
                            <input type="hidden" class="form-control" name="menuId">
                        </div>
                        <label for="lastname" class="col-sm-2 control-label">新增产品名称<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="name" maxlength="100" id="newProductType">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="mark" maxlength="100">

                        </div>
                        <label for="modelName" class="col-sm-2 control-label" style="display: none">treeKey<font
                                color="red">*</font></label>
                        <div class="col-sm-4" style="display: none">
                            <input type="text" class="form-control" name="treeKey" maxlength="100" value="product">
                        </div>
                        <label for="modelName" class="col-sm-2 control-label">产品路径<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="productPath" maxlength="100"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="cycle" maxlength="100"></div>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">图层名称</label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="featureName" maxlength="100">
                        </div>
