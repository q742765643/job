                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="jobDesc" placeholder="请输入“任务名称”" maxlength="100" value="${jobInfo.jobDesc}"></div>
                            <label for="lastname" class="col-sm-2 control-label">任务执行策略<font color="red">*</font></label>
                            <div class="col-sm-4">
                            	<#-- <input type="text" class="form-control" name="jobCron" placeholder="请输入“任务执行策略”" maxlength="20" value="${jobInfo.jobCron}"> -->
                                <select class="form-control selectpicker show-tick" data-live-search="true"  name="jobCron" >
                                	<#list executionStrategyList as eStrategy>
										<#if eStrategy.dictCode == jobInfo.jobCron>
	                                        <option value="${eStrategy.dictCode}" selected="selected">${eStrategy.dictName}</option>
	                                    <#else>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <#list flowModelList as item>
                                    <#if item.id == jobInfo.modelId>
                                        <option value="${item.id}" selected="selected">${item.processCHName}</option>
                                    <#else>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <#list ExecutorRouteStrategyEnum as item>
                                    <#if item == jobInfo.executorRouteStrategy>
                        ...
                        <input type="hidden" value="${jobInfo.executorParam}" id="executorParam" name="executorParam">
                        <input type="hidden" value="${jobInfo.id}" id="id" name="id">
                        <input type="hidden" id="dynamicParameter" name="dynamicParameter">
                        <input type="hidden"  id="priority" value="${jobInfo.priority}">
                        <input type="hidden"  id="modelIdInput" value="${jobInfo.modelId}">
                        <input type="hidden"  name="tasktype" value="${jobInfo.tasktype}" id="tasktypevalue" >
                        <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    <div id="rootwizard3">
                        <ul>
                            <li><a href="#tab8" data-toggle="tab"><span class="label"></span> 全色影像路径选择方式</a></li>
                        </ul>
                        <div class="tab-content">
                        	<div class="radio">
                            ...
                            <div class="tab-pane" id="tab8">
                                <hr>
                                <#--<div class="form-group">
                                    <label for="firstname" class="col-sm-2 control-label">已选全色影像<font color="red">*</font></label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control " name="pan_xml_path1" value=""/>
                                    </div>
                                </div>-->
                            </div>
                        </div>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					...
					<hr>
					<div class="form-group">
						<div class="col-sm-offset5 col-sm-6">
...
<script src="${request.contextPath}/static/adminlte/plugins/daterangepicker/moment.min.js"></script>
<script src="${request.contextPath}/static/js/jobflow/jobflowUpdate.js"></script>
