            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="locked" class="form-control" id="province－add">
                            </select>
                        </div>
                         <label for="modelName" class="col-sm-2 control-label">市 ：</label>
                        <div class="col-sm-4">
                            <select name="locked" class="form-control"  id="city－add">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="region" class="form-control" id="county-add" >
                            </select>
                        </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                   ...
                   <div class="form-group">
                        <label for="modelName" class="col-sm-2 control-label">省 ：</label>
                        <div class="col-sm-4">
                            <select name="locked" class="form-control" id="province-update">
                            </select>
                        </div>
                         <label for="modelName" class="col-sm-2 control-label">市 ：</label>
                        <div class="col-sm-4">
                            <select name="locked" class="form-control"  id="city-update">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <label for="modelName" class="col-sm-2 control-label">县 ：</label>
                        <div class="col-sm-4">
                            <select name="region" class="form-control" id="county-update" >
                            </select>
                        </div>
                         <label for="modelName" class="col-sm-2 control-label">状态</label>
                        <div class="col-sm-4">
