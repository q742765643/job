        ...
        <div class="col-sm-10">
            <div class="row">
                ...
                <div class="col-xs-1">
                    ...
                    <button class="btn btn-primary btn-success add" >添加功能</button>
                    </@shiro.hasPermission>
                </div>
            </div>
            <p></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">图标路径</label>
                        <div class="col-sm-4">
...
<script src="${request.contextPath}/static/js/dataAdmin/module.index.1.js"></script>
