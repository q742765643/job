                            ...
                            <div class="tab-pane" id="tab1">
                                ...
                                <div class="form-group">
                                    ...
                                    <#--  <input type="text" class="form-control" name="modelIdentify"
                                            placeholder="请输入“模型标识”" maxlength="100">-->
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="text" maxlength="100"></div>

                        <label for="lastname" class="col-sm-2 control-label" style="display: none">新增算法分类名称<font
                                color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="treeKey" maxlength="100"
                ...
                <form class="form-horizontal form" role="form">
                    <div id="rootwizard1">
                        ...
                        <div class="tab-content">
                            ...
                            <#--<input type="text" class="form-control" name="uploadPath" value="" maxlength="100">-->
                            <#--</div>-->
                            <#--</div>-->
                                <div class="form-group col-sm-6">
