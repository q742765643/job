...
$(function() {
    table = $("#table").dataTable({
        ...
        "aaSorting": [[1, "asc"]],
        "ajax": {
            url: base_url + "/dbms_role/pageList",
            type: "post",
            data: function(d) {
                var obj = {};
                var obj = {
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "dbms_role/saveRole", $("#addModal .form").serialize(),
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "dbms_role/saveRole", $("#updateModal .form").serialize(),
                function(data, status) {
                    if (data.code == "200") {
    ...
    $("#table").on('click', '.grant',
        function() {
            ...
            $.ajax({
                type : "POST",
                url : base_url + "dbms_module/tree/"+id,
                dataType : 'json',
    ...
    var grantModalValidate = $("#grantModal .form").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: base_url + "dbms_role/grant/" + id,
    ...
    layer.confirm('确认删除?', {
        ...
        function(index) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: base_url + "dbms_role/delRole/" + id,
                success: function(data) {
                    if (data.code == 200) {
                    	layer.msg( "删除成功", {
        					icon: 1,
