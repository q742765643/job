...
$(function() {
    table = $("#table").dataTable({
        ...
        "aaSorting": [[1, "asc"]],
        "ajax": {
            url: base_url + "dbms_module/pageList",
            type: "post",
            data: function(d) {
                var obj = {};
                var obj = {
    ...
    var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "dbms_module/saveModule", $("#addModal .form").serialize(),
    ...
    $("#table").on('click', '.update',
        function() {
            ...
            $('#updateModal .form select[name=isHide] option[value=' + row.isHide + ']').prop('selected', true);
            $('#updateModal').modal({
                backdrop: false,
                keyboard: false
            }).modal('show');
    ...
    var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler: function(form) {
            $.post(base_url + "/dbms_module/savesModule", $("#updateModal .form").serialize(),
                function(data, status) {
                    if (data.code == "200") {
    ...
    $.ajax({
        type : "POST",
        url : base_url + "dbms_module/allTree",
        dataType : 'json',
...
function zTreeOnClick(event, treeId, treeNode) {
	...
	table = $("#table").dataTable({
        ...
        "aaSorting": [[1, "asc"]],
        "ajax": {
            url: base_url + "dbms_module/pageList?id="+treeNodeId,
            type: "post",
            data: function(d) {
                var obj = {};
                var obj = {
	...
	$("#table").on('click', '.update',
	    ...
	    var updateModalValidate = $("#updateModal .form").validate({
	        ...
	        submitHandler: function(form) {
	            $.post(base_url + "/dbms_module/saveModule", $("#updateModal .form").serialize(),
	                function(data, status) {
	                    if (data.code == "200") {
	                        $('#updateModal').modal('hide');
	                        layer.msg( "更新成功", {
    ...
    layer.confirm('确认删除?', {
        ...
        function(index) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: base_url + "dbms_module/delModule/" + id,
