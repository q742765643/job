package com.htht.job.admin.controller.interceptor;

import com.htht.job.admin.controller.annotation.PermessionLimit;
import com.htht.job.admin.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    public static boolean login(HttpServletResponse response, boolean ifRemember, String username, String password) {
