...
public interface XxlJobLogDao {
    ...
    public int clearOneLog(@Param("id") int id);

    public int updateSuspend(@Param("id") int id,
                             @Param("suspend") int suspend);

    public List<XxlJobLog> selectClearLoglist(@Param("jobGroup") int jobGroup,
                                              @Param("jobId") int jobId,
                                              @Param("clearBeforeTime") Date clearBeforeTime,
                                              @Param("clearBeforeNum") int clearBeforeNum);
