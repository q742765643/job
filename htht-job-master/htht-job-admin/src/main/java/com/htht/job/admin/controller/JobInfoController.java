...
public class JobInfoController {
    ...
    @ResponseBody
    public List<AtomicAlgorithmDTO> getAtomicAlgorithms(HttpServletRequest request, HttpServletResponse response, String productId) {
        List<AlgorithmRelationInfoDTO> algoId = dubboService.queryAlgo(productId);
        List<AtomicAlgorithmDTO> list = new ArrayList();
        for (AlgorithmRelationInfoDTO algoid : algoId) {
    ...
    public String getJobParameter(String jobId, String parameterId, String mark) {
        String data="";
        data =taskParametersService.getJobParameterMap(jobId, parameterId, mark);
        return data;
    }
