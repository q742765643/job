...
public class ProcessStepsDTO extends BaseEntity {
    /**
     * 原子算法id
     */
    ...
    @Transient
    private List<ParallelLogDTO> parallelLogDTOS;
    ...
    public List<ParallelLogDTO> getParallelLogDTOS() {
        return parallelLogDTOS;
    }

    public void setParallelLogDTOS(List<ParallelLogDTO> parallelLogDTOS) {
        this.parallelLogDTOS = parallelLogDTOS;
    }
