...
public final class DateUtil {
	...
	public static synchronized java.sql.Timestamp getTimestamp2(String strDate) {
		ParsePosition pos = new ParsePosition(0);
		java.util.Date date = forMatterDateTime2().parse(strDate, pos);
		if (date != null) {
			return (new java.sql.Timestamp(date.getTime()));
		}
		return null;
	...
	public static synchronized String getDateTimeString(long lTime) {
		StringBuffer strDate = new StringBuffer();
		forMatterDateTime().format(new java.util.Date(lTime), strDate,
				new FieldPosition(0));
...
//		Date date = new Date();
//		Date date1 = new Date();
//		date1 = DateUtil.strToDate("20140205120000", "yyyyMMddHHmmss");
//		System.out.println(DateUtil.formatDateTime(date1, "yyyyMMddHHmmss"));
//		// date1.setDate(date1.getDate()+1);
////		date1.setHours(date1.getHours() + 1);
////		date1.setMinutes(date1.getMinutes() + 2);
////		date1.setSeconds(date1.getSeconds() + 3);
////		String dateDifference = DateUtil.getDateDifference(date, date1);
////		System.out.println(dateDifference);
//		String forPath = DateUtil.getPathByDate("d:/yscd/{yyyy/MM}/cds",date1);
