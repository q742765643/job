...
public class UusRole extends BaseEntity {
    ...
    private java.util.Set<DataCategoryDTO> category;        //功能目录
    ...
    public java.util.Set<DataCategoryDTO> getCategory() {
        return category;
    }

    public void setCategory(java.util.Set<DataCategoryDTO> category) {
