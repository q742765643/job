...
public class ArchiveFiledMapService extends BaseService<ArchiveFiledMap> {
     ...
     * @return
     */
    public List<ArchiveFiledMap> getArchiveFiledMap(String archiveRuleId) {
        List<QueryCondition> queryConditions = new ArrayList<QueryCondition>();
        queryConditions.add(new QueryCondition(" archive_rule_id ='" + archiveRuleId + "'"));
        try {
    ...
    public int saves(List<ArchiveFiledMap> fileMapList, String id, String catalogcode) {
        ...
        try {
            for (ArchiveFiledMap archiveFiledMap : fileMapList) {
                ...
                archiveFiledMap.setDefault_val(archiveFiledMap.getDefault_val());
            }
